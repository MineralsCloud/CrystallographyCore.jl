...
[CrystallographyCore](https://github.com/MineralsCloud/CrystallographyCore.jl).
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("CrystallographyCore")
   ```

3. Run

   ```julia-repl
   julia> using CrystallographyCore
   ```
...
version of CrystallographyCore, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/CrystallographyCore.jl"
```
...
our [GitHub repository](https://github.com/MineralsCloud/CrystallographyCore.jl)
for new releases.
Once we release a new version, you can update CrystallographyCore by typing

```@repl
using Pkg
Pkg.update("CrystallographyCore")
Pkg.gc()
```
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("CrystallographyCore")

   julia> Pkg.gc()
   ```

2. Press `Ctrl+D` to quit the current session. Start a new Julia session and
   reinstall CrystallographyCore.
